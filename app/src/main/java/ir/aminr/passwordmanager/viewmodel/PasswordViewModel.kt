...
@Inject constructor(
    ...
    private val _updatePasswordState = MutableStateFlow<UpdatePasswordState>(UpdatePasswordState.Empty)
    val updatePasswordState:StateFlow<UpdatePasswordState> = _updatePasswordState

    private val _deletePasswordState = MutableStateFlow<DeletePasswordState>(DeletePasswordState.Empty)
    val deletePasswordState:StateFlow<DeletePasswordState> = _deletePasswordState

    private val _insertPasswordState = MutableStateFlow<InsertPasswordState>(InsertPasswordState.Empty)
